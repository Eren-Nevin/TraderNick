<script lang="ts">
  ...
  const AVAILABLE_KINDS: ChartKind[] = ['ohlcv', 'volume', 'bs', 'sz', 'token_leaderboard', 'smart_wallets_table', 'smart_wallets_dynamic', 'smart_wallets_cutoff', 'gmx_v2', ...HL_CHART_KINDS];
