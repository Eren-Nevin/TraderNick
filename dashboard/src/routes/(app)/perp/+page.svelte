<script lang="ts">
  ...
  const AVAILABLE_KINDS: ChartKind[] = ['ohlcv', 'volume', 'bs', 'sz', 'token_leaderboard', 'smart_wallets_table', 'smart_wallets_dynamic', 'smart_wallets_cutoff', 'smart_wallets_group', 'backtracker', 'backtracker_leaderboard', 'early_movers', 'trading_pit', 'group_snapshot', 'gmx_v2', ...HL_CHART_KINDS];
