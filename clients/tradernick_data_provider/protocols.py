...
class StaderNamespace:
    ...
    def _q(self, event: str) -> EventQuery:
        return EventQuery(self._session, self._base_url, "/evm/stader/read", {"event": event})
    ...
    async def flush(self, network: str | None = None, event: str | None = None) -> None:
        ...
        if event is not None:
            body["event"] = event
        await self._session.post(self._base_url + "/evm/stader/flush", json=body)
    ...
    async def flush_aggregate(
        ...
        if period is not None:
            body["period"] = period
        await self._session.post(self._base_url + "/evm/stader/aggregate/flush", json=body)
    ...
    async def compact(self, network: str | None = None, event: str | None = None) -> None:
        ...
        if event is not None:
            body["event"] = event
        await self._session.post(self._base_url + "/evm/stader/compact", json=body)
    ...
    async def compact_aggregate(
        ...
        if period is not None:
            body["period"] = period
        await self._session.post(self._base_url + "/evm/stader/aggregate/compact", json=body)
...
class ThresholdNamespace:
    ...
    def _q(self, event: str) -> EventQuery:
        return EventQuery(self._session, self._base_url, "/evm/threshold/read", {"event": event})
    ...
    async def flush(self, network: str | None = None, event: str | None = None) -> None:
        ...
        if event is not None:
            body["event"] = event
        await self._session.post(self._base_url + "/evm/threshold/flush", json=body)
    ...
    async def flush_aggregate(
        ...
        if period is not None:
            body["period"] = period
        await self._session.post(self._base_url + "/evm/threshold/aggregate/flush", json=body)
    ...
    async def compact(self, network: str | None = None, event: str | None = None) -> None:
        ...
        if event is not None:
            body["event"] = event
        await self._session.post(self._base_url + "/evm/threshold/compact", json=body)
    ...
    async def compact_aggregate(
        ...
        if period is not None:
            body["period"] = period
        await self._session.post(self._base_url + "/evm/threshold/aggregate/compact", json=body)
