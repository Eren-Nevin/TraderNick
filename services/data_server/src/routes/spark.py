"""Spark events aggregate endpoint. 6 events (AAVE V3 fork by Sky/Maker).
Charts select by (chain, token) — single market per chain."""
...
_EVENT_TABLES = {
    "deposit":     ("tradernick.spark_deposits",     "amount",        None),
    "withdraw":    ("tradernick.spark_withdrawals",  "amount",        None),
    "borrow":      ("tradernick.spark_borrows",      "amount",        None),
    "repay":       ("tradernick.spark_repays",       "amount",        None),
    "flashloan":   ("tradernick.spark_flashloans",   "amount",        None),
    "liquidation": ("tradernick.spark_liquidations", "debt_to_cover", "debt_token"),
}
