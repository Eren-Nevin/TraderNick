"""Binance open_interest backfill. defistream 2.22 multi-token form."""
import asyncio
import json
import logging
import signal
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("usage: python -m jobs.backfill_binance_open_interest <job_id>", file=sys.stderr); sys.exit(2)
