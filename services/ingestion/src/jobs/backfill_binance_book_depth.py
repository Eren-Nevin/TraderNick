"""Binance book_depth backfill. Same multi-token chunk shape as OI."""
import asyncio
import json
import logging
import signal
...
import config
from clickhouse import BOOK_DEPTH_COLUMNS, async_client, book_depth_df_to_rows, force_purge_tokens
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("usage: python -m jobs.backfill_binance_book_depth <job_id>", file=sys.stderr); sys.exit(2)
